...
public class MkResponseTestConfig {
    ...
    public static final MkBidResponse XxlbidResponseTest (MkBidRequest request) {
        ...
        checkViews.add("http://adx.fxlxz.com/adx-mk/api/jc/pv?pv="+ Base64.encode(request.getId()));
        bid.setCheck_views(checkViews);
        List<String> clickList = new ArrayList<>();
        clickList.add("http://adx.fxlxz.com/adx-mk/api/jc/click?click="+ Base64.encode(request.getId()));
